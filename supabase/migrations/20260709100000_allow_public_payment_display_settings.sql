-- Customer payment pages need these non-secret display settings to show the
-- correct network/token/admin receiving wallet before creating a payment.
-- Keep private contract and service-only settings hidden.
