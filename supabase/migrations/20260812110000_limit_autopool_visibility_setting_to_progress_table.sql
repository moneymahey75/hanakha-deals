-- The AutoPool visibility setting controls only the detailed level table.
-- Every enrolled member must always receive the summary used in section 1.
...
BEGIN
  ...
  -- The detailed eight-level matrix is the only administrator-controlled
  -- section. The membership summary above is always returned.
  IF v_enabled THEN
