-- Re-credit ROI-to-ROI rows that were previously locked because eligibility
-- was evaluated too narrowly. Launch reward coupons treat active/upgraded launch
-- subscriptions as eligible, so ROI level cap must use the same rule.
