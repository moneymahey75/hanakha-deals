/*
  # Fix reserved upgrade wallet transaction reference type

  tbl_wallet_transactions.twt_reference_id is uuid, so upgrade payment IDs must
  be inserted as uuid values, not text.
*/
