-- Paged version of the customer referral network RPC.
-- Designed for large downlines (thousands of users) by supporting:
-- - level filtering (so you can view one level at a time)
-- - pagination (offset/limit)
-- - search (matches sponsorship, username, name, email)
-- Also returns summary stats (total_count, direct_referrals, max_depth) on every row.
--
