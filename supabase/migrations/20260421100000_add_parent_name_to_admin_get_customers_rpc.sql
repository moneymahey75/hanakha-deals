/*
  # Add parent name to admin_get_customers RPC
*/
...
COMMENT ON FUNCTION admin_get_customers IS 'Fetches customer data for admin dashboard (includes parent name). Uses SECURITY DEFINER to bypass RLS.';
