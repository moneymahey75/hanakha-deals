/*
  # Allow direct Launch upgrade payments without reserved wallet rows

  Direct USDT upgrade payments pass p_reserved_used = 0. In that case the RPC
  should not require a working wallet row; the wallet row is only needed when
  reserved balance is actually being consumed.
*/
